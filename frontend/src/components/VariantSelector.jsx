    ...
    return (
        <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
                <label className="text-[11px] font-bold text-gray-400 uppercase tracking-widest pl-1">Color</label>
                <div className="relative group">
                    <select
                        ...
                        className="w-full h-14 bg-white border border-gray-100 rounded-2xl px-5 text-[14px] font-semibold text-black appearance-none focus:outline-none focus:ring-2 focus:ring-black/5 hover:border-gray-300 transition-all cursor-pointer"
                    >
                        {colors.map(color => (
